<!DOCTYPE html>
<html lang="en">
<title>แก้ไขการลงทะเบียนรายวิชาที่เปิดสอน</title> 
...
<div id="main">
    ...
    <h1 class="w3-font">แก้ไขผลการลงทะเบียนรายวิชาที่เปิดสอน</h1>
  ...
  <tbody>
    <tr>
      ...
      <td>T12-3,T12-4</td>
      <td>100</td>
      <td><a class="btn btn-warning btn-sm text-black">แก้ไข</a></td>
      <td><a class="btn btn-danger btn-sm text-black">ลบ</a></td>
    </tr>
    <tr>
      <th scope="row">2</th>
      <td>03603341-60</td>
...
<a href="#" class="btn btn-light text-black" style="float:right;">ยืนยัน</a> 
<a href="" class="btn btn-light text-black ms-auto " style="float:right;">เพิ่มรายวิชา</a>
    </div>
